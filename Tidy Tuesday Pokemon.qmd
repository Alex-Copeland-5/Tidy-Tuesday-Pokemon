...
total_pokemon1_wins <- data.frame(pokemon = total_win_loss_pokemon$pokemon1, wins = total_win_loss_pokemon$wins_pokemon1)

total_pokemon2_wins <- data.frame(pokemon = total_win_loss_pokemon$pokemon2, wins = total_win_loss_pokemon$wins_pokemon2)

# rbind to get a total win for all pokemon
total_pokemon_wins <- rbind(total_pokemon1_wins, total_pokemon2_wins)

# aggregate to find winner
results <- aggregate(wins ~ pokemon, data = total_pokemon_wins, sum)
